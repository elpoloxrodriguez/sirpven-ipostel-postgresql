...
import { IPOSTEL_C_PagosDeclaracionOPP_SUB, IPOSTEL_U_Pagos_Mantenimiento } from '@core/services/empresa/form-opp.service';
      ...
      (data) => {
        if (data.Cuerpo.length > 0) {
          data.Cuerpo.map(e => {
            ...
            e.monto_pagado = this.utilService.ConvertirMoneda(e.monto_pagado)
